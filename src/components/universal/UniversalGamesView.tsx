    ...
    <div className="space-y-6 text-white pb-10">
      ...
      {universalGames.length === 0 ? (
        <div className="p-10 bg-slate-900 border border-slate-800 rounded-3xl text-center space-y-3">
          ...
          <h3 className="text-sm font-bold text-slate-300">No Universal Games Active</h3>
          <p className="text-xs text-slate-500 max-w-md mx-auto">
            Universal Games are created and drawn directly by Spain Game Admin. Currently there are no active universal draw games. You can sell tickets for active Solo or Multiplayer games.
          </p>
        </div>
      ) : (
